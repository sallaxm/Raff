...
with m as (
  ...
  from public.majors
  where institution_id='udst' and slug='me-smart-manufacturing'
),
c as (
...
x as (
  select * from (values
    ...
    ('AECH2112',2,2,false),('AECH3302',2,2,false),('AEMA2113',2,2,false),('AEMA2213',2,2,false),
    ('AEMA2133',2,2,false),('AEMA2233',2,2,false),('AEMA3301',2,2,false),
